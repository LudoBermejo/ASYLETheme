...
<head>
    ...
    <?php wp_head(); ?>
    <script src="/asyle/wp-content/themes/asyle/lib/jquery/jquery-1.11.2.min.js"></script>
    <script src="/asyle/wp-content/themes/asyle/js/interaction.js"></script>
    ...
    <div class="wrapper">
        <header class="main">
            <div class="inner">
                ...
                <button class="menu-trigger"><img src="/asyle/wp-content/themes/asyle/img/burger-icon.png"></button>
